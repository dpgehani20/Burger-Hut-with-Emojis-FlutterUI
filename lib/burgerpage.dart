...
class _BurgerPageState extends State<BurgerPage> {
    ...
    return Padding(
      ...
      child: Column(
        children: [
          //*don't
          if(columnNumber == '1')
            _columnItem('assets/emoji/cheese.png', 'Sweet cheese', '11', Color(0xFFFBD6F5)),
          if(columnNumber == '1')
            SizedBox(height: 15.0),
          if(columnNumber == '1')
            _columnItem('assets/emoji/popcorn.png', 'Sweet popcorn', '11', Color(0xFFFBD6F5)),
          if(columnNumber == '2')
            _columnItem('assets/emoji/taco.png', 'Tacos', '6',
                Color(0xFFC2E3FE)),
          if(columnNumber == '2')
            SizedBox(height: 15.0),
          if(columnNumber == '2')
            _columnItem('assets/emoji/sandwich.png', 'Sandwich', '6',
                Color(0xFFD7FADA)),
        ],
      ),
    );
  ...
  _columnItem(String imgPath, String foodName, String price, Color bgColor) {
    return Row(
      mainAxisAlignment: MainAxisAlignment.spaceBetween,
      children: <Widget>[
        Container(
